...
import firstImage from "images/second.jpg";
import secondImage from "images/third.jpg";
  ...
  const cards = [
    {
      imageSrc: firstImage
        ,
      subtitle: "Paid",
      title: "Boost teamwork, improve communication.",
      description:
...

    {
      imageSrc:
        secondImage,
      subtitle: "Free",
      title: "Seamless interaction boosts productivity.",
      description:
        "Efficient collaboration enhances work output.",
      url: "https://timerse.com"
    },

    {
      imageSrc:
        thirdImage,
      subtitle: "Exclusive",
      title: "Collaborate for business success.",
      description:
        "Embrace collaboration and communication for business success.",
      url: "https://timerse.com"
    }
  ];
    ...
    <Container>
      <SingleColumn>
        <HeadingInfoContainer>
          <HeadingTitle>More Collaboration, Better Communication</HeadingTitle>
          <HeadingDescription>
            Foster a culture of enhanced collaboration and seamless communication with our solutions, promoting productivity and synergy within your team.
          </HeadingDescription>
        </HeadingInfoContainer>
        <Content>
          {cards.map((card, i) => (
